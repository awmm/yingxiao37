...
- (void)setDefaultValues
{
    ...
    self.menuMonthTextColor = [UIColor lightGrayColor];
    self.weekDayTextColor = [UIColor colorWithRed:152./256. green:147./256. blue:157./256. alpha:1.];
    
    [self setDayDotColorForAll:[UIColor colorWithRed:224./256. green:84./256. blue:39./256. alpha:1.]];
    ...
    self.dayCircleColorSelected = [UIColor colorWithRed:((float)((0xf3ad4d & 0xFF0000) >> 16))/255.0 green:((float)((0xf3ad4d & 0xFF00) >> 8))/255.0 blue:((float)(0xf3ad4d & 0xFF))/255.0 alpha:1.0];

...
- (void)addLeavingView
{
    ...
    //这里 拿到请假发给的对象
    _waiteLabel = [ViewTool getLabelWith:CGRectMake(_nameLabel.x, _nameLabel.maxY + 1.5 * topSpace , [UIView getWidth:100], [UIView getHeight:15]) WithTitle:@"等待谁谁谁的审批" WithFontSize:12.0f WithTitleColor:grayFontColor WithTextAlignment:NSTextAlignmentLeft];
...
#warning 获得请假事由计算高度
    ...
    //
    approView1.nameString = [NSString stringWithFormat:@"我(%@)",@"小花花"];
